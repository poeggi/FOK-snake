...
onmessage = (e) => {
    ...
    switch (m.t) {
        ...
        case 'duelStartNet':   // a (re)start: fresh seed/startPts, rollback state rebased
            ...
            simCommand({ t:'startDuel', seed:m.seed>>>0, net:true, ws:m.ws, hearts:m.hearts, lvl:m.lvl, speed:m.speed });   // net: deaths hold for the negotiated respawn boundary; hearts/lvl/speed = the go's negotiated cap, starting level and speed-round rule
