...
//  2. Centred text (x = CW/2) never names a scale row as a number: 24, 90, 116, 182, 324,
//     348, 370, 382, 390 are TITLE_Y, MENU_TOP, DLG_TITLE_Y, OVL_TITLE_Y, STATUS_Y,
//     BACK_Y, BAND_Y, CORNER_Y, HINT_Y.
const fs = require('fs'), path = require('path');
const JS = path.join(__dirname, '..', 'js');
const FILES = ['screens.js', 'tourney.js', 'events.js', 'render.js', 'input.js', 'game.js'];
const PAINTERS = /^function draw(Title|DialogTitle|OverlayTitle)\(/;
const ROWS = /\b(24|90|116|182|324|348|370|382|390)\b/;
const bad = [];
