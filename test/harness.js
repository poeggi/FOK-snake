...
function runInGame(driver) {
    ...
    const src = ['sw-update.js', 'hmac.js', 'assets.js', 'audio.js', 'sim.js', 'storage.js', 'game.js', 'text.js', 'qr.js', 'render.js', 'screens.js', 'input.js', 'duel-core.js', 'net-api.js', 'net-rtc.js', 'net-relay.js', 'net-session.js', 'net-spec.js', 'tourney.js', 'events.js', 'items.js']
